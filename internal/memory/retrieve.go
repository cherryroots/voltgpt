...
func formatFactsXML(userFacts []UserFacts, generalFacts []GeneralFact) string {
	...
	sb.WriteString("<note>The <user> sections contain facts about the people you are currently talking to. The <general> section contains facts about OTHER people that may be topically relevant — never attribute general facts to the person you are speaking with.</note>\n")
